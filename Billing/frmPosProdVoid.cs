...
{
    public partial class frmPosProdVoid : Form
    {
        connString cs = new connString();
        Product_Menu.frmPos fp = null;
        public int voidType = 0; //1 = product void || 2 = void transaction

        public frmPosProdVoid(Product_Menu.frmPos _fp)
        {
            InitializeComponent();
             fp = _fp;
        }
        ...
        private void frmPosProdVoid_Load(object sender, EventArgs e)
        {

        }

        private void frmPosProdVoid_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Dispose();
        }
